!(function (a, b) {
  ...
  function g(a) {
    try {
      return ".com" !== a.substring(a.lastIndexOf("."))
        ? (a.split(".") || []).length <= 3
          ? a
          : a.split(".").slice(1).join(".")
        : a.substring(a.lastIndexOf(".", a.lastIndexOf(".") - 1) + 1);
    } catch (b) {
  ...
  function l(a, b, c) {
    ...
    var e = "/";
    (document.cookie =
      a + "=;path=" + e + ";domain=." + b + ";expires=" + d.toGMTString()),
      (document.cookie =
        a +
        "=;path=" +
        e +
  ...
  function n() {
    ...
    var d = [
      ...
      g = f[2] || "taobao.com",
      h = f[1] || "m";
    "taobao.net" !== g || ("x" !== h && "waptest" !== h && "daily" !== h)
      ? "taobao.net" === g && "demo" === h
        ? (h = "demo")
        : "alibaba-inc.com" === g && "zebra" === h
        ? (h = "zebra")
        : "waptest" !== h && "wapa" !== h && "m" !== h && (h = "m")
      : (h = "waptest");
    var i = "h5api";
  ...
  function o() {
    ...
    d && ((s.AliAppName = d[1]), (s.AliAppVersion = d[2]));
    var e = b.match(/AMapClient\/([\d\.\_]+)/i);
    e && ((s.AliAppName = "AMAP"), (s.AliAppVersion = e[1]));
  }
  function p(a) {
  ...
  var s = { useJsonpResultType: !1, safariGoLogin: !0, useAlipayJSBridge: !1 },
    t = [],
    u = { ERROR: -1, SUCCESS: 0, TOKEN_EXPIRED: 1, SESSION_EXPIRED: 2 };
  n(), o();
  var v = /[Android|Adr]/.test(a.navigator.userAgent),
    w = "AP" === s.AliAppName,
    x =
      (w && m(s.AliAppVersion, "10.1.2") >= 0) ||
      ("KB" === s.AliAppName && m(s.AliAppVersion, "7.1.62") >= 0) ||
      (v && "AMAP" === s.AliAppName && m(s.AliAppVersion, "1.0.1") >= 0),
    y = 0,
    z = "2.6.3";
  (p.prototype.use = function (a) {
    ...
    (p.prototype.__processRequestMethod = function (a) {
      var b = this.params,
        c = this.options;
      "get" === b.type && "jsonp" === b.dataType
        ? (c.getJSONP = !0)
        : "get" === b.type && "originaljsonp" === b.dataType
        ? (c.getOriginalJSONP = !0)
        : "get" === b.type && "json" === b.dataType
        ? (c.getJSON = !0)
        : "post" === b.type && (c.postJSON = !0),
        a();
    }),
    (p.prototype.__processRequestType = function (c) {
      ...
      if (
        ...
        "undefined" == typeof f.WindVaneRequest &&
        "undefined" == typeof f.H5Request
      ) {
        if (
          (b.windvane && parseFloat(f.WindVaneVersion) >= 5.4
            ? (f.WindVaneRequest = !0)
            : (f.H5Request = !0),
          x)
        ) {
          if (((f.WindVaneRequest = f.H5Request = void 0), a.AlipayJSBridge))
            if (i(e.data)) f.WindVaneRequest = !0;
            else
              try {
                i(JSON.parse(e.data))
                  ? (f.WindVaneRequest = !0)
          ...
          "AMAP" !== s.AliAppName ||
            e.useNebulaJSbridgeWithAMAP ||
            ((f.WindVaneRequest = f.H5Request = void 0), (f.H5Request = !0));
        }
      ...
      return (
        h.indexOf("youku") > -1 &&
          f.mainDomain.indexOf("youku.com") < 0 &&
          ((f.WindVaneRequest = !1), (f.H5Request = !0)),
        f.mainDomain.indexOf("youku.com") > -1 &&
          h.indexOf("youku") < 0 &&
          ((f.WindVaneRequest = !1), (f.H5Request = !0)),
        c
          ? c().then(function () {
              ...
              if (
                ...
                (f.WindVaneRequest === !0 && x && f.retJson.error) ||
                  !a ||
                  a.indexOf("PARAM_PARSE_ERROR") > -1 ||
                  a.indexOf("HY_FAILED") > -1 ||
                  a.indexOf("HY_NO_HANDLER") > -1 ||
                  a.indexOf("HY_CLOSED") > -1 ||
                  a.indexOf("HY_EXCEPTION") > -1 ||
                  a.indexOf("HY_NO_PERMISSION") > -1)
              ) {
                if (
                  !x ||
                  !isNaN(f.retJson.error) ||
                  -1 !== f.retJson.error.indexOf("FAIL_SYS_ACCESS_DENIED")
                )
                  return (
                    x && i(e.data) && (e.data = JSON.stringify(e.data)),
                    (s.H5Request = !0),
                    d.__sequence([
                      d.__processRequestType,
                      d.__processToken,
                      d.__processRequestUrl,
                      d.middlewares,
                      d.__processRequest,
                    ])
                  );
                "undefined" == typeof f.retJson.api &&
                  "undefined" == typeof f.retJson.v &&
                  ((f.retJson.api = e.api),
                  (f.retJson.v = e.v),
                  (f.retJson.ret = [
                    f.retJson.error + "::" + f.retJson.errorMessage,
                  ]),
                  (f.retJson.data = {}));
              }
            })
  ...
  (p.prototype.__getTokenFromAlipay = function () {
    ...
    return (
      d.useAlipayJSBridge === !0 &&
      !e &&
      x &&
      a.AlipayJSBridge &&
      a.AlipayJSBridge.call
        ? a.AlipayJSBridge.call(
            "getMtopToken",
            function (a) {
    ...
    (p.prototype.__waitWKWebViewCookie = function (b) {
      var c = this.options;
      c.waitWKWebViewCookieFn &&
      c.H5Request &&
      a.webkit &&
      a.webkit.messageHandlers
        ? c.waitWKWebViewCookieFn(b)
        : b();
    }),
          ...
          ? r
              ...
              .then(function () {
                ...
                if (
                  ...
                  d.indexOf("TOKEN_EMPTY") > -1 ||
                    ((c.CDR === !0 || c.syncCookieMode === !0) &&
                      d.indexOf("ILLEGAL_ACCESS") > -1) ||
                    d.indexOf("TOKEN_EXOIRED") > -1)
                ) {
                  if (
                    ((c.maxRetryTimes = c.maxRetryTimes || 5),
                    (c.failTimes = c.failTimes || 0),
                    c.H5Request && ++c.failTimes < c.maxRetryTimes)
                  ) {
                    var e = [
                      b.__waitWKWebViewCookie,
                      b.__processToken,
                      b.__processRequestUrl,
                      b.middlewares,
                      b.__processRequest,
                    ];
                    if (
                      ...
                      if (b.constructor.__cookieProcessor) {
                        var f = function (a) {
                          ...
                          b.constructor.__cookieProcessor
                            ? b.constructor.__cookieProcessor
                                .then(c)
                                ["catch"](c)
                            : a();
    ...
    (p.prototype.__processRequestUrl = function (b) {
      ...
      if (d.H5Request === !0) {
        var f =
          ...
          k = { jsv: z, appKey: g, t: i, sign: j },
          l = { data: c.data, ua: c.ua };
        Object.keys(c).forEach(function (a) {
          "undefined" == typeof k[a] &&
          ...
          c.ext_querys &&
            Object.keys(c.ext_querys).forEach(function (a) {
              k[a] = c.ext_querys[a];
            }),
          d.getJSONP
            ? (k.type = "jsonp")
          ...
          "undefined" != typeof c.valueType &&
            ("original" === c.valueType
              ? d.getJSONP || d.getOriginalJSONP
                ? (k.type = "originaljsonp")
                : (d.getJSON || d.postJSON) && (k.type = "originaljson")
              : "string" === c.valueType &&
                (d.getJSONP || d.getOriginalJSONP
                  ? (k.type = "jsonp")
                  : (d.getJSON || d.postJSON) && (k.type = "json"))),
          d.useJsonpResultType === !0 &&
            "originaljson" === k.type &&
            delete k.type,
  ...
  (p.prototype.__requestJSONP = function (a) {
    ...
    return (
      (l.src = h.path + "?" + f(h.querystring) + "&" + f(h.postdata)),
      (l.async = !0),
      (l.onerror = function () {
    ...
    (p.prototype.__requestJSON = function (b) {
      ...
      var m,
        n,
        o = h.path + "?" + f(h.querystring);
      h.getJSON
        ? ((m = "GET"), (o += "&" + f(h.postdata)))
        : h.postJSON && ((m = "POST"), (n = f(h.postdata))),
        i.open(m, o, !0),
        (i.withCredentials = !0),
    ...
    (p.prototype.__requestWindVane = function (a) {
      ...
      "undefined" != typeof f.valueType &&
        ("original" === f.valueType
          ? (l = "originaljson")
          : "string" === f.valueType && (l = "")),
      ...
      var m,
        ...
        t = f.ext_querys || {};
      (n =
        "undefined" != typeof f.timer
          ? parseInt(f.timer)
          : "undefined" != typeof f.timeout
          ? parseInt(f.timeout)
          : 2e4),
        (m = 2 * n),
        f.needLogin === !0 &&
          "undefined" == typeof f.sessionOption &&
          (q = "AutoLoginAndManualLogin"),
        "undefined" != typeof f.secType &&
          "undefined" == typeof f.isSec &&
          (p = f.secType);
      var u = {
        api: i,
        v: j,
      ...
      f.ttid && g.dangerouslySetWVTtid === !0 && (u.ttid = f.ttid),
        Object.assign &&
          f.dangerouslySetWindvaneParams &&
          Object.assign(u, f.dangerouslySetWindvaneParams);
      var v = "MtopWVPlugin";
      return (
        "string" == typeof f.customWindVaneClassName &&
    ...
    (p.prototype.__requestAlipay = function (b) {
      ...
      i(f.data) || (f.data = JSON.parse(f.data)),
        ...
        (g.getJSON || g.postJSON || g.getOriginalJSONP) &&
          (h.type = "originaljson"),
        "undefined" != typeof f.valueType &&
          ("original" === f.valueType
            ? (h.type = "originaljson")
            : "string" === f.valueType && delete h.type),
        g.useJsonpResultType === !0 && delete h.type,
        Object.assign &&
          f.dangerouslySetAlipayParams &&
          Object.assign(h, f.dangerouslySetAlipayParams);
      var j = "mtop";
      return (
        "string" == typeof f.customAlipayJSBridgeApi &&
          (j = f.customAlipayJSBridgeApi),
  ...
  (p.prototype.request = function (c) {
    ...
    var h = q
      ...
      .then(function (a) {
        ...
        return e.__sequence([
          b,
          e.__processRequestMethod,
          e.__processRequestType,
          e.__processToken,
      ...
      .then(function () {
        ...
        return a.retType !== u.SUCCESS
          ? q.reject(a)
          : e.options.successCallback
          ? void e.options.successCallback(a)
          : q.resolve(a);
      })
      ["catch"](function (a) {
        var c;
        return (
          a instanceof Error
            ? (console.error(a.stack),
              (c = { ret: [a.message], stack: [a.stack], retJson: u.ERROR }))
            : (c =
                "string" == typeof a
                  ? { ret: [a], retJson: u.ERROR }
                  : void 0 !== a
                  ? a
                  : e.options.retJson),
          ...
          e.options.failureCallback
            ? void e.options.failureCallback(c)
            : q.reject(c)
        );
      });
    return (
  ...
  (function (a, b) {
    ...
    function e(b, d) {
      ...
      g.style.cssText = [
        "-webkit-transform:scale(" + f + ") translateZ(0)",
        "-ms-transform:scale(" + f + ") translateZ(0)",
        "transform:scale(" + f + ") translateZ(0)",
        ...
        "left:0",
        "top:0px",
        "background:" + (i > 800 ? "rgba(0,0,0,.5)" : "#FFF"),
        "display:none",
      ].join(";");
      ...
      (n.style.cssText = [
        ...
        l
          ? (k.appendChild(m), g.appendChild(k))
          : ((m.style.cssText = [
              "position:absolute",
              "width:15px",
              "height:15px",
      ...
      return a().then(function () {
        var a = d.retJson,
          ...
          h =
            g.indexOf("safari") > -1 &&
            g.indexOf("chrome") < 0 &&
            g.indexOf("qqbrowser") < 0;
        if (
          (f instanceof Array && (f = f.join(",")),
          (f.indexOf("SESSION_EXPIRED") > -1 ||
            f.indexOf("SID_INVALID") > -1 ||
            f.indexOf("AUTH_REJECT") > -1 ||
            f.indexOf("NEED_LOGIN") > -1) &&
            ((a.retType = l.SESSION_EXPIRED),
            !d.WindVaneRequest &&
              (k.LoginRequest === !0 ||
                d.LoginRequest === !0 ||
                e.needLogin === !0)))
          ...
          if (d.safariGoLogin !== !0 || !h || "taobao.com" === d.pageDomain)
            return b.login
              ...
              .then(function (a) {
                return c.__sequence([
                  c.__processToken,
                  c.__processRequestUrl,
                  c.__processUnitPrefix,
                  c.middlewares,
                  c.__processRequest,
                ]);
              })
    ...
    function g(a) {
      var b = this.options;
      this.params;
      return b.H5Request !== !0 || (k.AntiFlood !== !0 && b.AntiFlood !== !0)
        ? void a()
        : a().then(function () {
            var a = b.retJson,
              c = a.ret;
            c instanceof Array && (c = c.join(",")),
              c.indexOf("FAIL_SYS_USER_VALIDATE") > -1 &&
                a.data.url &&
                (b.AntiFloodReferer
                  ? (location.href = a.data.url.replace(
                      /(http_referer=).+/,
                      "$1" + b.AntiFloodReferer
                    ))
    ...
    function h(b) {
      var c = this,
        ...
        g = this.params;
      return (
        f.AntiCreep !== !1 && (f.AntiCreep = !0),
        (g.forceAntiCreep !== !0 && f.H5Request !== !0) ||
        (k.AntiCreep !== !0 && f.AntiCreep !== !0)
          ? void b()
          : b().then(function () {
              var b = f.retJson,
                h = b.ret;
